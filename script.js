...
//check local storage for best scores, set best score array values
function getSavedBestScores(){
  ...
  bestScoresToDOM();//save to local storage
...
//format and dsiplay time in dom
...
//Stope Timer, process results, go to score page
function checkTime() {
  console.log('time:',timePlayed);
  if (playerGuessArray.length == questionAmount){
    console.log('player guess array:', playerGuessArray);
    clearInterval(timer);
    //check for wrong guesse, add penalty time
    equationsArray.forEach((equation, index) => {  
      if (equation.evaluated === playerGuessArray[index]){
        //correct guess, no pppenalit
      } else {
...
// Get the value from out selected radio button
